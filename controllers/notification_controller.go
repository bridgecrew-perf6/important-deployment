...
//+kubebuilder:rbac:groups=deployment.my.domain,resources=notifications,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=deployment.my.domain,resources=notifications/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=deployment.my.domain,resources=notifications/finalizers,verbs=update
